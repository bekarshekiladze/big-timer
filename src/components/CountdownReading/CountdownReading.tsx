...
export default function CountdownReading() {
  ...
  const { hours: h, minutes: m, seconds: s, showHoursSeparator, showMinutesSeparator } = formatTimeDisplay(hours, minutes, seconds)
  return <div className="flex justify-center gap-2 p-4 font-bigtimer text-timer align-middle">
